...
public class CreateWireCommand implements Command {
	private WireGE wire;
	...
	public CreateWireCommand(AbstractVertex start, ArrayList<WireGE> wires, ArrayList<BlockGE> blocks, MouseEvent e) {
		this.blocks = blocks;
		this.wires = wires;
		this.start = start;
		...
		this.wire = new WireGE(start, end);
		//System.out.println(wire.getAllVertices());
		wires.add(wire);
	}
	...
	public void onRelease(MouseEvent e) {
		//System.out.println(start.getEquivalentVertex()+"  "+end.getEquivalentVertex());
